...
class Solution {
  public:
    string doIntersect(int p1[], int q1[], int p2[], int q2[]) {
        ...
        bool chk211 = p2[1]-p1[1] - slope1*(p2[0]-p1[0]) >0?true:false;
        bool chk212 = q2[1]-p1[1] - slope1*(q2[0]-p1[0]) >0?true:false;
        bool chk121 = p1[1]-p2[1] - slope2*(p1[0]-p2[0]) >0?true:false;
        bool chk122 = q1[1]-p2[1] - slope2*(q1[0]-p2[0]) >0?true:false;
